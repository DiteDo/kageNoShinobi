...
public class ProductFoodBuilding extends ProductionBuilding {
    //CONSTRUCTOR
    public ProductFoodBuilding(Position position, Sprite sprite, Characteristic charac, Behavior behavior, int maxStock, long timeToProduct) {
        super(position, sprite, charac, behavior, maxStock, timeToProduct);
    }
}
